...
<body class="text-center justify-content-center">
    ...
    <main class="form-signin w-100 m-auto rounded-4" style="background-color: #F8EDE3;">
        <form novalidate class="needs-validation" action="proses/p_login.php" method="POST">
            <!-- <img class="mb-4" src="../assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"> -->
            <i class="bi bi-cup-hot-fill fs-1"></i>
            <h1 class="h3 my-3 fw-normal">Cafe V~Coffe</h1>
            <div class="form-floating">
                <input name="username" type="email" class="form-control mb-2" id="floatingInput" placeholder="name@example.com" required>
            ...
            <div class="form-floating">
                ...
                <span id="togglePassword" class="eye-icon" onclick="togglePasswordVisibility()">
                    <img id="eyeImage" src="assets/images/eye_open.png" alt="Show Password">
                </span>
                <div class="invalid-feedback">
                    Input password
                </div>
            </div>
            <button class="w-100 mt-3 mb-3 btn btn-lg fw-bold text-light" style="background-color: #85586F;" type="submit" value="sumbit" name="submit_validate">Login</button>
            Guest? <a class="link-dark link-underline-opacity-0 fw-semibold" href="register">Register Here!</a>
            <p class="mt-5 mb-3 text-body-secondary">&copy;2023 Muhammad Rifqi Nurfadillah</p>
        </form>
    </main>

    <!-- SCRIPT FOR FITUR SHOW PASSWORD -->
    <script>
        ...
        function togglePasswordVisibility() {
            if (passwordInput.type === "password") {
                ...
                eyeImage.src = "assets/images/eye_closed.png";
            } else {
                passwordInput.type = "password";
                eyeImage.src = "assets/images/eye_open.png";
            }
        }
    </script>
