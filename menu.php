                                    ...
                                    <form action="proses/p_input_menu.php" class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col d-flex justify-content-center mb-3">
                                                <div style="width: 200px;"><img src="../vcoffe/assets/images/<?php echo $row['foto']; ?>" class="img-fluid" alt="..."></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-nowrap">
                                    ...
                                    <td>
                                        <div style="width: 80px;"><img src="../vcoffe/assets/images/<?php echo $row['foto']; ?>" class="img-thumbnail" alt="..."></div>
                                    </td>
